...
export type ModelTypes = {
	...
	["StringId"]: ModelTypes["Question"] | ModelTypes["Answer"] | ModelTypes["User"];
	["Question"]: {
		content: string,
	score: number,
	_id: string,
	...
	["Dated"]: ModelTypes["Question"] | ModelTypes["Answer"] | ModelTypes["User"];
...
export type GraphQLTypes = {
	...
	["StringId"]: {
	__typename:"Question" | "Answer" | "User",
	_id: string
	['...on Question']: '__union' & GraphQLTypes["Question"];
	['...on Answer']: '__union' & GraphQLTypes["Answer"];
